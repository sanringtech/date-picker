...
export const widgetGranularityMulti: WidgetRangeDictionary = {
  ...
  pageDescription:
    'Composed Widget 層（<code class="font-mono text-xs">@sanring/date-picker-widget</code>）： DateGranularityMultiPickerComponent，年度 toggle 多選選取器。',
  cardTitle: 'DateGranularityMultiPicker（W6-multi，年度多選模式）',
  cardDescription:
