...
export const widgetTimeRange: WidgetRangeDictionary = {
  ...
  pageDescription:
    'Composed widget layer (<code class="font-mono text-xs">@sanring/date-picker-widget</code>): DateTimeRangePickerComponent — combined date-range + dual-end time picker.',
  cardTitle: 'DateTimeRangePicker (W8, date range + time mode)',
  cardDescription:
