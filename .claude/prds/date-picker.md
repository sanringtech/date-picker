...
| M5 | 2026-09-27 | npm 發布準備：README/API 文件、CHANGELOG、`0.1.0` 版本號定案、bundle size 實測、demo app 作為長期回歸測試基準、Public npm `@sanring` org 發布設定 | README 涵蓋全部 Public API Surface；bundle size 符合預算（✅ 2026-07-18 復測：13.03 KB gzip，含 M6/M7，見第 9 節風險表）；`npm publish --dry-run` 通過 |
