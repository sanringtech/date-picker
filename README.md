...
Provided per `CalendarGridDirective` instance. Access via the exported template reference: `#grid="sanringCalendarGrid"` → `grid.engine`.
...
- Year view / Decade view / Month picker
